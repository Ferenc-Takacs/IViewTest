...
struct jpeg_decompress_struct {
  ...
  UINT16 X_density;		/* Horizontal pixel density */
  UINT16 Y_density;		/* Vertical pixel density */
  double X_d_density;		/* Horizontal pixel density */ /* Babo 2003.08.11 */
  double Y_d_density;		/* Vertical pixel density */ /* Babo 2003.08.11 */
  double xres,yres; //taxi
  int chkComment,chkBody,chkMarker; //taxi
...
struct jpeg_error_mgr {
  ...
  JMETHOD(void, error_exit, (j_common_ptr cinfo, int nomess));
  /* Conditionally emit a trace or warning message */
  JMETHOD(void, emit_message, (j_common_ptr cinfo, int msg_level));
  /* Routine that actually outputs a trace or error message */
  JMETHOD(int, output_message, (j_common_ptr cinfo));
...
struct jpeg_source_mgr {
  ...
  JMETHOD(boolean, seek_input_data, (j_decompress_ptr cinfo, long byte_offset));   /* optionals */
  uFile * infile;		/* source stream */
...
#ifdef __cplusplus
EXTERN(void) jpeg_stdio_dest JPP((j_compress_ptr cinfo, uFile & outfile));
EXTERN(void) jpeg_stdio_src JPP((j_decompress_ptr cinfo, uFile & infile));
#endif
